...
%
%\tdplotsetmaincoords{60}{110} ORIGINAL
\tdplotsetmaincoords{75}{110}

%define polar coordinates for some vector
\pgfmathsetmacro{\rvec}{1.1}
\pgfmathsetmacro{\thetavec}{40}% phi
\pgfmathsetmacro{\phivec}{60}% psi
...
%\draw[thick,->] (0,0,0) -- (0.7,-0.5,0) node[anchor=north east]{$x$};
...
\tdplotdrawarc{(O)}{0.2}{0}{\phivec}{anchor=north}{$\psi$}
...
%draw theta arc and label, using rotated coordinate system\overrightarrow{AB}\overrightarrow{\phi}
...
%use the tdplot_rotated_coords style to work in the rotated, translated coordinate frame\widehat{ABC}
\draw[thick,tdplot_rotated_coords,->] (0,0,0) -- (.5,0,0) node[anchor=north west]{$\overrightarrow{\phi}$};
\draw[thick,tdplot_rotated_coords,->] (0,0,0) -- (0,.5,0) node[anchor=west]{$\overrightarrow{\psi}$};
\draw[thick,tdplot_rotated_coords,->] (0,0,0) -- (0,0,.5) node[anchor=south]{$\widehat{r}$};
...
%\draw[-stealth,color=blue,tdplot_rotated_coords] (0,0,0) -- (.2,.3,0);
\draw[dashed,color=blue,tdplot_rotated_coords] (.2,-.3,0) -- (.2,.3,0);
\draw[dashed,color=blue,tdplot_rotated_coords] (.2,.3,0) -- (-.2,.3,0);
\draw[dashed,color=blue,tdplot_rotated_coords] (-.2,-.3,0) -- (-.2,.3,0);
\draw[dashed,color=blue,tdplot_rotated_coords] (.2,-.3,0) -- (-.2,-.3,0);
